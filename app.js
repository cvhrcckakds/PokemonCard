...
pokemonDiv.style.backgroundColor=`${pokemonBg}`
    ...
    <div class="poke-info">
        ...
        <div class="small">
            <small class="poke-exp"> <i class="fas fa-flask"></i>${pokemon.base_experience} exp</small>
            <small class="poke-weight"> <i class="fas fa-weight-hanging"></i>${pokemon.weight / 10} kg</small>
        </div>
        <div class="poke-type">
